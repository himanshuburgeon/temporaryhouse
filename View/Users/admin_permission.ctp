						...
						<table width="100%">
							...
							<tr>					
								...
								<td width="100%" colspan="3" align="center">
									<div style="" id="permission<?=$module['file']?>"><?php echo $this->Form->radio('content.'.$module['file'],array('1'=>'','2'=>'','3'=>''),array('label'=>false,'legend'=>false,'disabled'=>$disabled,'style'=>'margin-left:50px;margin-right:25px;'));?></div>
								</td>					
							</tr>
